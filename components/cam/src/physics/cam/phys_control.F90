...
integer  :: dribble_tend_into_macmic_loop = 0
...
subroutine phys_ctl_readnl(nlfile)
   ...
   call mpibcast(dribble_tend_into_macmic_loop,   1 , mpiint,  0, mpicom)
...
!-----------------------------------------------------------------------
   ...
   integer,           intent(out), optional :: dribble_tend_into_macmic_loop_out
   ...
   if ( present(dribble_tend_into_macmic_loop_out ) ) dribble_tend_into_macmic_loop_out = dribble_tend_into_macmic_loop
